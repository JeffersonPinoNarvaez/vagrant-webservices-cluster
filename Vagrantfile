...
Vagrant.configure("2") do |config|
  ...
  config.vm.define :webApp1 do |webApp1|
    ...
    webApp1.vm.provision "shell", path: "./provisions/web-servers/webApp1.sh"
  ...
  config.vm.define :webApp2 do |webApp2|
    ...
    webApp2.vm.provision "shell", path: "./provisions/web-servers/webApp2.sh"
  ...
  config.vm.define :webApp3 do |webApp3|
    ...
    webApp3.vm.provision "shell", path: "./provisions/web-servers/webApp3.sh"
